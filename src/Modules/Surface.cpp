...
CON_COMMAND(p2sm_font_get_name, "p2sm_font_get_name <id> - gets the name of a font from its index\n") {
	if (args.ArgC() != 2) {
		return console->Print(p2sm_font_get_name.ThisPtr()->m_pszHelpString);
	}
...
CON_COMMAND(p2sm_font_list, "p2sm_font_list - lists all available fonts\n") {
