...
Variable p2sm_aim_point_hud("p2sm_aim_point_hud", "0", "Overlays a marker with coordinates at the point you're aiming at\n");
...
CON_COMMAND(p2sm_aim_point_add, "p2sm_aim_point_add - add frozen aimpoint at current position\n") {
...
CON_COMMAND(p2sm_aim_point_clear, "p2sm_aim_point_clear - clear all frozen aimpoints\n") {
...
static bool shouldDraw() {
	...
	if (!p2sm_aim_point_hud.GetBool()) return false;
	return true;
}
