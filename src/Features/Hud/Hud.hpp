...
#define HUD_ELEMENT_NO_DISABLE(name, type)                                                     \
	void p2sm_hud_element_##name##_callback(HudContext *ctx);                                      \
	HudElement p2sm_hud_element_##name("p2sm_hud_" #name, p2sm_hud_element_##name##_callback, type); \
	void p2sm_hud_element_##name##_callback(HudContext *ctx)
#define HUD_ELEMENT(name, value, desc, type)                                                  \
	Variable p2sm_hud_##name("p2sm_hud_" #name, value, desc, FCVAR_DONTRECORD);                    \
	void p2sm_hud_element_##name##_callback(HudContext *ctx);                                     \
	HudElement p2sm_hud_element_##name(&p2sm_hud_##name, p2sm_hud_element_##name##_callback, type); \
	void p2sm_hud_element_##name##_callback(HudContext *ctx)
#define HUD_ELEMENT_STRING(name, value, desc, type)                                                 \
	Variable p2sm_hud_##name("p2sm_hud_" #name, value, desc, FCVAR_DONTRECORD);                          \
	void p2sm_hud_element_##name##_callback(HudContext *ctx, const char *text);                         \
	HudStringElement p2sm_hud_element_##name(&p2sm_hud_##name, p2sm_hud_element_##name##_callback, type); \
	void p2sm_hud_element_##name##_callback(HudContext *ctx, const char *text)
#define HUD_ELEMENT_MODE(name, value, min, max, desc, type)                                       \
	Variable p2sm_hud_##name("p2sm_hud_" #name, value, min, max, desc, FCVAR_DONTRECORD);              \
	void p2sm_hud_element_##name##_callback(HudContext *ctx, int mode);                               \
	HudModeElement p2sm_hud_element_##name(&p2sm_hud_##name, p2sm_hud_element_##name##_callback, type); \
	void p2sm_hud_element_##name##_callback(HudContext *ctx, int mode)
// First+second screen
#define HUD_ELEMENT2_NO_DISABLE(name, type)                                                          \
	void p2sm_hud_element_##name##_callback(HudContext *ctx);                                            \
	HudElement p2sm_hud_element_##name("p2sm_hud_" #name, p2sm_hud_element_##name##_callback, type, true); \
	void p2sm_hud_element_##name##_callback(HudContext *ctx)
...
#define HUD_ELEMENT_STRING2(name, value, desc, type)                                                      \
	Variable p2sm_hud_##name("p2sm_hud_" #name, value, desc, FCVAR_DONTRECORD);                                \
	void p2sm_hud_element_##name##_callback(HudContext *ctx, const char *text);                               \
	HudStringElement p2sm_hud_element_##name(&p2sm_hud_##name, p2sm_hud_element_##name##_callback, type, true); \
	void p2sm_hud_element_##name##_callback(HudContext *ctx, const char *text)
#define HUD_ELEMENT_MODE2(name, value, min, max, desc, type)                                            \
	Variable p2sm_hud_##name("p2sm_hud_" #name, value, min, max, desc, FCVAR_DONTRECORD);                    \
	void p2sm_hud_element_##name##_callback(HudContext *ctx, int mode);                                     \
	HudModeElement p2sm_hud_element_##name(&p2sm_hud_##name, p2sm_hud_element_##name##_callback, type, true); \
	void p2sm_hud_element_##name##_callback(HudContext *ctx, int mode)
// Specify game version
#define HUD_ELEMENT3(name, value, desc, type, showOnSecondScreen, version)                                                 \
	Variable p2sm_hud_##name("p2sm_hud_" #name, value, desc, FCVAR_DONTRECORD);                                                 \
	void p2sm_hud_element_##name##_callback(HudContext *ctx);                                                                  \
	HudElement p2sm_hud_element_##name(&p2sm_hud_##name, p2sm_hud_element_##name##_callback, type, showOnSecondScreen, version); \
	void p2sm_hud_element_##name##_callback(HudContext *ctx)
#define HUD_ELEMENT_STRING3(name, value, desc, type, showOnSecondScreen, version)                                                \
	Variable p2sm_hud_##name("p2sm_hud_" #name, value, desc, FCVAR_DONTRECORD);                                                       \
	void p2sm_hud_element_##name##_callback(HudContext *ctx, const char *text);                                                      \
	HudStringElement p2sm_hud_element_##name(&p2sm_hud_##name, p2sm_hud_element_##name##_callback, type, showOnSecondScreen, version); \
	void p2sm_hud_element_##name##_callback(HudContext *ctx, const char *text)
#define HUD_ELEMENT_MODE3(name, value, min, max, desc, type, showOnSecondScreen, version)                                      \
	Variable p2sm_hud_##name("p2sm_hud_" #name, value, min, max, desc, FCVAR_DONTRECORD);                                           \
	void p2sm_hud_element_##name##_callback(HudContext *ctx, int mode);                                                            \
	HudModeElement p2sm_hud_element_##name(&p2sm_hud_##name, p2sm_hud_element_##name##_callback, type, showOnSecondScreen, version); \
	void p2sm_hud_element_##name##_callback(HudContext *ctx, int mode)

extern Variable p2sm_hud_spacing;
extern Variable p2sm_hud_x;
extern Variable p2sm_hud_y;
extern Variable p2sm_hud_font_index;
extern Variable p2sm_hud_font_color;
extern Variable p2sm_hud_precision;
extern Variable p2sm_hud_shorthand;
