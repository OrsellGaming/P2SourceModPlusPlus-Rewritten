...
Variable p2sm_portalgun_hud("p2sm_portalgun_hud", "0", "Enables the portalgun HUD.\n");
Variable p2sm_portalgun_hud_x("p2sm_portalgun_hud_x", "5", 0, "The x position of the portalgun HUD.\n");
Variable p2sm_portalgun_hud_y("p2sm_portalgun_hud_y", "5", 0, "The y position of the portalgun HUD.\n");
...
bool PortalgunHud::ShouldDraw() {
	return p2sm_portalgun_hud.GetBool() && Hud::ShouldDraw() && sv_cheats.GetBool();
}
...
void PortalgunHud::Paint(int slot) {
	...
	int x = p2sm_portalgun_hud_x.GetInt();
	int y = p2sm_portalgun_hud_y.GetInt();
